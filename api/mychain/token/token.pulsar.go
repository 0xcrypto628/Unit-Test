...
func init() {
	file_mychain_token_token_proto_init()
	md_Token = File_mychain_token_token_proto.Messages().ByName("Token")
...
func (x *fastReflection_Token) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mychain.token.Token.name":
		return x.Name != ""
	case "mychain.token.Token.symbol":
		return x.Symbol != ""
	case "mychain.token.Token.supply":
		return x.Supply != uint64(0)
	case "mychain.token.Token.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mychain.token.Token"))
		}
		panic(fmt.Errorf("message mychain.token.Token does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Token) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mychain.token.Token does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Token) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "mychain.token.Token.name":
		panic(fmt.Errorf("field name of message mychain.token.Token is not mutable"))
	case "mychain.token.Token.symbol":
		panic(fmt.Errorf("field symbol of message mychain.token.Token is not mutable"))
	case "mychain.token.Token.supply":
		panic(fmt.Errorf("field supply of message mychain.token.Token is not mutable"))
	case "mychain.token.Token.owner":
		panic(fmt.Errorf("field owner of message mychain.token.Token is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mychain.token.Token"))
		}
...
func (x *fastReflection_Token) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mychain.token.Token", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_mychain_token_token_proto_init()
	md_TokenBalance = File_mychain_token_token_proto.Messages().ByName("TokenBalance")
...
func (x *fastReflection_TokenBalance) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mychain.token.TokenBalance.amount":
		return x.Amount != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mychain.token.TokenBalance"))
		}
		panic(fmt.Errorf("message mychain.token.TokenBalance does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TokenBalance) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mychain.token.TokenBalance does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TokenBalance) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "mychain.token.TokenBalance.amount":
		panic(fmt.Errorf("field amount of message mychain.token.TokenBalance is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mychain.token.TokenBalance"))
		}
...
func (x *fastReflection_TokenBalance) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mychain.token.TokenBalance", d.FullName()))
	}
	panic("unreachable")
}
...
var file_mychain_token_token_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x61, 0x0a, 0x05, 0x54, 0x6f,
	...
	,
}
...
var file_mychain_token_token_proto_goTypes = []interface{}{
...
func file_mychain_token_token_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mychain_token_token_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Token); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mychain_token_token_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
